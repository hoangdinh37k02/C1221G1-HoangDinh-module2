        ...
        do {
            ...
            switch (choice){
                ...
                case 3:
                    ...
                    for (int i=0; i<truckList.size(); i++){
                        if (truckList.get(i).getNumberPlate()==deleteNumberPlate){
                            truckList.remove(i);
                        }
                    }
                    for (int i=0; i<otoList.size(); i++){
                        if (otoList.get(i).getNumberPlate()==deleteNumberPlate){
                            otoList.remove(i);
                        }
                    }
                    for (int i=0; i<motorList.size(); i++){
                        if (motorList.get(i).getNumberPlate()==deleteNumberPlate){
                            motorList.remove(i);
                        }
                    }
                    break;
